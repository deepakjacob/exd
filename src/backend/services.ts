import { ControlType, State } from "../types";
      ...
      allComponents: {
        components: [
          ...
          },
          {
            component: {
              componentType: ControlType.COMPOSITE,
              id: "DATA_TABLE_CONTROL_ID_2567-137a-b298-d091-1171-0d9b-e4d2-2ec8",
              name: "DATA_TABLE_CONTROL_NAME_8132-ab25-60c2-44b9-cc34-fae4-997d-e99b",
              designComponentType: "COMPOSITE",
            },
            controls: [
              {
                id: "data_table_id_b5b5-9375-dfb8-7f89-0501-376d-41e4-62ed",
                name: "data_table_name_f851-ad8b-7e32-230e-5b8b-68ec-4576-f7ac",
                type: "DATA_TABLE",
                metadata: { dimension: { width: 12 } },
                overriden: { dimension: { width: "" } },
              },
